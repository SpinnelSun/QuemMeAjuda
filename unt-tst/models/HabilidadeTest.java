...
public class HabilidadeTest {
	...
	public void testCriarTutoriaDisciplinaVazia() {
		...
		Habilidade habilidade = new Habilidade("", 5);
	}
	...
	public void testCriarTutoriaDisciplinaNull() {
		...
		Habilidade habilidade = new Habilidade(null, 5);
	}
	...
	public void testCriarTutoriaProficienciaNegativa() {
		...
		Habilidade habilidade = new Habilidade("Programacao 2", -1);
	}
	...
	public void testCriarTutoriaProficienciaZero() {
		...
		Habilidade habilidade = new Habilidade("Programacao 2", 0);
	}
	...
	public void testCriarTutoriaProficienciaPositiva() {
		...
		Habilidade habilidade = new Habilidade("Programacao 2", 6);
	}
