...
public class AjudaPresencialTest {
	...
	public void testGetInfo() {
		...
		String msg3 = "Avaliacao da obtenção do atributo hora a partir da String passada como parametro.";
		assertEquals(msg3, "15:00", this.ajuda.getInfo("horario"));
		
		String msg4 = "Avaliacao da obtenção do atributo dia a partir da String passada como parametro.";
		assertEquals(msg4, "seg", this.ajuda.getInfo("dia"));
		
		String msg5 = "Avaliacao da obtenção do atributo local a partir da String passada como parametro.";
		assertEquals(msg5, "LCC3", this.ajuda.getInfo("localInteresse"));
		
		String msg6 = "Avaliacao da obtenção do atributo matriculaTutor a partir da String passada como parametro.";
		assertEquals(msg6, "999999999", this.ajuda.getInfo("tutor"));
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testGetInfoAtributoVazio() {
		String msg = "Avaliacao da excecao lancada ao tentar obter um atributo de uma AjudaPresencial a partir de uma String vazia.";
	...
	public void testGetInfoAtributoNulo() {
		String msg = "Avaliacao da excecao lancada ao tentar obter um atributo de uma AjudaPresencial a partir de um null.";
